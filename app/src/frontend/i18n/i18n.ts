...
const resources = {
  ...
  es: {
    translation: {
      ...
      "About the Colouring Cities Research Programme": "Acerca del programa de investigación Colouring Cities",
      ...
      "Building information (link)": "Informacion de la Construcción (link)",
      ...
      "You're one of the first people to use the site!":"¡Eres una de las primeras personas en utilizar el sitio!",
      "Please": "Por favor",
      "discuss suggestions for improvements":"discute sugerencias de mejora",
      "and":"y",
      "report issues or problems":"reporta incidencias o problemas",
      "Username*":"Nombre de usuario",
      "Password":"Contraseña",
      "Show password?":"Ver contraseña",
      "Forgotten password?":"¿Ha olvidado su contraseña?",
      "Sign Up":"Regístrese",
      "Would you like to create an account instead?":"¿Le gustaría crear una cuenta en su lugar?",
      "Logging in...":"Iniciando sesión...",
      "Log In":"Iniciar Sesión",
      "Log in":"Iniciar sesión",
      "please note the user name you choose will be public":"El nombre de usuario que elija será público",

      "Forgotten password":"Contraseña olvidada",
      "Please provide the e-mail address associated with your account. A password reset link will be sent to your mailbox.":"Proporcione la dirección de correo electrónico asociada a su cuenta. Se le enviará un enlace de restablecimiento de contraseña a su buzón de correo.",
      ...
      "You're one of the first people to sign up!":"Eres uno de los primeros en inscribirte.",
      "Create an account to start colouring in.":"Cree una cuenta para empezar a colorear.",
      "not-your-real-name":"no-su-nombre-real",
      "Email (optional)":"Correo (Opcional)",
      "Our policy is to avoid collecting personal data wherever possible. An email address is only necessary if you wish to be able to recover your account should you forget your password.":"Nuestra política es evitar recabar datos personales siempre que sea posible. Una dirección de correo electrónico solo es necesaria si desea poder recuperar su cuenta en caso de que olvide su contraseña.",
      "someone@example.com":"ejemplo@ejemplo.com",
      "Confirm email (optional)":"Confirmar correo electrónico (opcional)",
      "Password (at least 8 characters)":"Contraseña (al menos 8 caracteres)",
      "I confirm that I have read and agree to the":"Confirmo que he leído y acepto la",
      "privacy policy":"política de privacidad",
      "contributor agreement":"acuerdo de colaboración",
      "data accuracy agreement":"acuerdo sobre la exactitud de los datos",
      "Do you already have an account?":"¿Ya tiene una cuenta?",
      "Please also read our":"Lea también nuestro",
      "data ethics policy":"política de ética de datos",
      "before using or sharing our data":"antes de utilizar o compartir nuestros datos",
      "Sign Up2":"Registrarse",
      "is under active development. Please":" está en desarrollo activo. Por favor,",
      "For reference, here are the":"Como referencia, aquí está la",
      "Start colouring":"Empezar a colorear",
      ...
      "Are you a software developer? If so, you might be interested in these.":"¿Eres desarrollador de software? Si es así, puede que esto te interese.",
      "Generate API key":"Generar clave API",
      "Open Source Code":"Fuente codigo avierto",
      "site code is developed at":"se desarrolla en",
      "on Github":"en Github",
      ...
      "Welcome,":"Bienvenido,",
      "Account":"Cuenta",
      "Open data extracts":"Extractos de datos abiertos",
      "Choose one of the links below to download an archive containing the open data collected on the Colouring Cities platform":"Elija uno de los siguientes enlaces para descargar un archivo que contiene los datos abiertos recopilados en la plataforma Colouring Cities.",
      "Colouring Cities contributions are open data, licensed under the":"Las contribuciones de Colouring Cities son datos abiertos, con licencia de",
      "by Colouring Cities contributors.":"realizada por colaboradores de Colouring Citites.",
      "You are free to copy, distribute, transmit and adapt our data, as long as you credit Colouring Cities and our contributors. If you alter or build upon our data, you may distribute the result only under the same licence.":"Puedes copiar, distribuir, transmitir y adaptar nuestros datos, siempre que des crédito a Colouring Cities y a nuestros colaboradores. Si modifica o desarrolla nuestros datos, sólo podrá distribuir el resultado bajo la misma licencia.",
      "Choose one of the links below to download an archive containing the open data collected on the Colouring Cities platform.":"Elija uno de los siguientes enlaces para descargar un archivo que contiene los datos abiertos recopilados en la plataforma Colouring Cities.",
      "By downloading data extracts from this site, you agree to the":"Al descargar extractos de datos de este sitio, usted acepta el",
      "and the":"y los",
      "No extracts available":"No hay extractos disponibles",
      "Leaderboard":"Tabla de líderes",
      "Select number of users to be displayed":"Seleccione el número de usuarios que se mostrarán",
      "Select time period":"Seleccione el periodo de tiempo",
      "Last 30 days":"Últimos 30 días",
      "Last 7 days":"Últimos 7 días",
      "Contributions":"Contribuciones",
      "You may use the UPRN for personal, non-commercial use or for the internal administration and operation of your business, which does not permit using the UPRN  for the purpose of creating or developing any product or service intended for sub-licensing, distribution or sale to third parties (notwithstanding that the UPRN  themselves or any associated attribution or geometry that has been created with benefit of UPRN may not actually be supplied as part of such product or service). Therefore if you create any data which has benefited from, relied on or made use of the UPRN you are not permitted to sub-license, distribute or sell such data to third parties under the above terms":"Puedes usar el UPRN para uso personal y no comercial, o para la administración interna y operación de tu negocio. Sin embargo, no se permite utilizar el UPRN con el propósito de crear o desarrollar productos o servicios destinados a sublicenciar, distribuir o vender a terceros, incluso si los UPRN en sí mismos, así como cualquier atribución o geometría asociada creada con el beneficio del UPRN, no se suministran realmente como parte de dicho producto o servicio. Por lo tanto, si creas cualquier dato que se haya beneficiado, basado o hecho uso del UPRN, no tienes permitido sublicenciar, distribuir o vender dichos datos a terceros bajo los términos mencionados anteriormente",
      "Ordnance Survey - UPRN Usage Terms":"Ordnance Survey - Términos de Uso de UPRN",
