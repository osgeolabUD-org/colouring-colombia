...
const resources = {
  ...
  es: {
    translation: {
      ...
      "FAR ratio (percentage of plot covered by building)":"Porcentaje del lote cubierto por el edificio",
      ...
      "Current Land Use (Order)": "Destinación del suelo (Orden)",
      ...
      "Total floor area (m²)": "Superficie total de laas plantas (m²)",
      ...
      "Source type": "Fuente",
      "Source link(s)":"Enlace(s) de referencia",
      "Building footprint ID": "Identificador de Lote",
      "URL(s) for building address data source(s).":"URL(s) for building address data source(s).",
      "Unique Property Reference Number(s) (UPRN)": "Número de referencia de la propiedad (NPN)",
      ...
      "Latitude of building centroid":"Latitud del centroide del edificio",
      "Longitude of building centroid": "Longitud del centroide del edificio",
    "Source of lcoordinate data.": "Fuente de datos de coordenadas.",
    "Link to a website with the name of the building.": "Enlace a un sitio web con el nombre del edificio.",
    "Correctly formatted UK postcode, i.e. NW1 2FB": "Código postal de la ciudad de Bogotá",
    "Source of address data.": "Fuente de datos de direcciones.",
    "Unique Property Reference Number(s) (UPRN) (derived automatically)": "Número(s) de Referencia Única de Propiedad (NPN)",
    "OpenStreetMap building ('way') ID - Numerical string of up to 9 characters": "ID del edificio de OpenStreetMap - Cadena numérica de hasta 9 caracteres",
    "URL(s) for building coordinate data source(s).": "URL(s) para la(s) fuente(s) de datos de coordenadas de construcción.",
    "Links to alternative building footprint datasets (include the direct link to the footprint of this building where possible).": "Enlaces a conjuntos de datos alternativos de huellas de edificios (incluye el enlace directo a la huella de este edificio cuando sea posible).",
    "Hint": "",
      "Ordnance Survey Topography Layer ID (TOID)": "Identificador de la construcción",
      ...
      "Current land use (order)": 'Destino económico predominante',
      ...
      "URL(s) for residential/non-residential data source(s)":"URL(s) para la(s) fuente(s) de datos residenciales/no residenciales",
      "We have prepopulated these based on their current attachment. A building can either be detached, semi-detached or part of a terrace (middle or end)": "Hemos prellenado esto en función de su conexión actual. Un edificio puede ser independiente, semidetachado o formar parte de una hilera (en medio o en el extremo).",
      "Coming Soon": "Próximamente",
       "What was the building <u><i>originally</i></u> used for when it was built?": "¿Para qué se utilizó originalmente el edificio cuando se construyó?",
       "Agriculture And Fisheries": "Agricultura y Pesca",
       "Industry And Business": "Industria y Negocios",
       "Recreation And Leisure": "Recreación y Ocio",
       "Residential": "Residencial",
       "Utilities And Infrastructure": "Servicios Públicos e Infraestructura",
       "Vacant And Derelict": "Vacante y Abandonado",
      ...
      "Frontage width (m)": 'Ancho del frente (m)',
      ...
      "boobs": "Porcentaje del lote cubierto por las geometrias de las construcciones",
      "URL(s) for plot area data source(s)": "URL(s) para la(s) fuente(s) de datos del área de trazado del gráfico",
"Source of FAR ratio data": "Fuente de datos de la proporción FAR (Factor de Área a Volumen)",
"URL(s) for parcel geometry data source(s)": "URL(s) para la(s) fuente(s) de datos de la geometría de la parcela",
"Total number of floors, calculated from other values.": "Número total de pisos, calculado a partir de otros valores.",
      ...
      "Assessed by eye/personal knowledge of the building": "Evaluado visualmente/conocimiento personal del edificio",
    "Assessed using professional knowledge of building or building type": "Evaluado utilizando conocimiento profesional del edificio o tipo de edificio",
    "Assessed using streetview photographs, satellite imagery or maps": "Evaluado utilizando fotografías de streetview, imágenes satelitales o mapas",
    "Assessed by specialist emergency group": "Evaluado por grupo de emergencia especializado",
    "Current government record/database": "Registro/base de datos gubernamental actual",
    "Live streamed from a government source": "Transmitido en vivo desde una fuente gubernamental",
    "Open database": "Base de datos abierta",
    "Other independently managed public database": "Otra base de datos pública gestionada de forma independiente",
    "Commercial database": "Base de datos comercial",
    "Inferred computationally using existing open attribute data": "Inferido computacionalmente utilizando datos de atributos abiertos existentes",
      ...
      "Source for the survival status": 'Fuente del estado de supervivencia',
        "References for date source (max 500 characters)": "Referencias para la fuente de la fecha (máximo 500 caracteres)",
        "URL for age and date reference": "URL para la referencia de la edad y la fecha",
        "How many floors are there between the pavement and start of roof?": "¿Cuántos pisos hay entre la acera y el inicio del techo?",
        "How many floors above start of roof?": "¿Cuántos pisos hay sobre el inicio del techo?",
        "How many floors below pavement level?": "¿Cuántos pisos hay debajo del nivel del pavimento?",
        "Source of building floors data": "Fuente de los datos de los pisos del edificio",
        "URL(s) for building floors data source(s)": "URL(s) de la(s) fuente(s) de datos de los pisos del edificio",
        "URL(s) for building height (apex) source(s)": "URL(s) de la(s) fuente(s) de datos de altura del edificio (vértice)",
        "URL(s) for building height (eaves) source(s)": "URL(s) de la(s) fuente(s) de datos de altura del edificio (alero)",
        "URL(s) for floor area data source(s)": "URL(s) de la(s) fuente(s) de datos de área del piso",
        "URL(s) for building frontage source(s)": "URL(s) de la(s) fuente(s) de datos de ancho del frente del edificio",  
      ...
      "Source type for age extension data":"Tipo de fuente para los datos de ampliación",
      ...
      "Source type for green space data":"Tipo de fuente de datos sobre espacios verdes",
      "Under development":"En desarrollo",
      "Type new land use group here":"Escriba aquí el nuevo grupo de uso del suelo",
      "Link to a website with the name of the building..":"Enlace a un sitio web con el nombre del edificio..",
      'Enterprise Zones on':"Zonas empresariales ON ",
      "Approximate distance from the front door of the building to the nearest public green space (in meters).":"Distancia aproximada desde la puerta principal del edificio hasta la zona verde pública más cercana (en metros).",
    ...
    "Fisheries": "Pesca",
    "Managed forest": "Bosque gestionado",
    "Un-managed forest": "Bosque no gestionado",
    "Mineral workings and quarries": "Explotaciones minerales y canteras",
    "Outdoor amenity and open spaces": "Espacios al aire libre y zonas abiertas",
    "Amusement and show places": "Lugares de entretenimiento y espectáculos",
    "Libraries, museums and galleries": "Bibliotecas, museos y galerías",
    "Sports facilities and grounds": "Instalaciones y terrenos deportivos",
    "Holiday parks and camps": "Parques de vacaciones y campamentos",
    "Allotments and city farms": "Parcelas de cultivo y granjas urbanas",
    "Transport tracks and ways": "Vías y rutas de transporte",
    "Transport terminals and interchanges": "Terminales e intercambios de transporte",
    "Car parks": "Aparcamientos",
    "Vehicle storage": "Almacenamiento de vehículos",
    "Goods and freight terminals": "Terminales de mercancías y carga",
    "Waterways": "Vías navegables",
    "Energy production and distribution": "Producción y distribución de energía",
    "Water storage and treatment": "Almacenamiento y tratamiento de agua",
    "Refuse disposal": "Eliminación de desechos",
    "Cemeteries and crematoria": "Cementerios y crematorios",
    "Post and telecommunications": "Correo y telecomunicaciones",
    "Dwellings": "Viviendas",
    "Hotels, boarding and guest houses": "Hoteles, pensiones y casas de huéspedes",
    "Residential institutions": "Instituciones residenciales",
    "Medical and health care services": "Servicios médicos y de atención médica",
    "Places of worship": "Lugares de culto",
    "Education": "Educación",
    "Community services": "Servicios comunitarios",
    "Shops": "Tiendas",
    "Financial and professional services": "Servicios financieros y profesionales",
    "Restaurants and cafes": "Restaurantes y cafés",
    "Public houses, bars and nightclubs": "Bares, pubs y discotecas",
    ...
    "Vacant": "Vacante",
    "Derelict": "Abandonado",
    "Unused land": "Terreno no utilizado",
    "Mixed domestic/non-domestic":"Mixto doméstico/no doméstico",
    "Source links":"Enlaces fuente",
    "https://beta.ordnancesurvey.co.uk/products/os-open-uprn":"sadasdas",
    "Garden buildings": "Edificios de jardín",
      ...
      "Our CA map records this building as not being within a CA. To help us verify this, please click ‘verify’ or, if info is incorrect, please add the local authority’s CA appraisal link.":"Nuestro mapa CA registra este edificio como no estar dentro de un CA. Para ayudarnos a verificarlo, haga clic en 'verificar' o, si la información es incorrecta, añada el enlace de la autoridad local a la evaluación de la AC",
      ...
      "Best estimate for the severity of damage to the building":"Mejor estimación de la gravedad de los daños en el edificio",
